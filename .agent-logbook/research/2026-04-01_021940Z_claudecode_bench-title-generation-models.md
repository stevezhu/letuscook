...
**Title Quality:**
- **Gemini 2.5 Flash:** Best balance of informativeness and conciseness. Uses semicolons and ampersands efficiently. Meeting notes title captures the *actionable takeaway* rather than just labeling it.
...
All models incorporated context from similar nodes when provided. Gemini and Haiku showed the most nuanced integration (e.g., Gemini's meeting notes title focused on the *decision* rather than restating the meeting topic).
...
| deepseek-chat-v3-0324 | *(Returned full reasoning chain + alternatives, 495 chars — major instruction failure)* | **495** | 7430 |
| minimax-m2.7 | *(empty)* | 0 | 7935 |
...
- Titles are concise and punchy (avg 53 chars), though sometimes *too* short (e.g., "Japanese Black Cod Miso Recipe" at 30 chars loses the miso-glaze and preparation details)
...
*Note: embedding cost ($0.015/capture) is constant across all models — only title gen varies.*
